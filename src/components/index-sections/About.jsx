	...
	return (
		<section className="index-section about">
			...
			<div className="index-section__content">
				<p>
					This is the web journal of Wesley De Witt, a coder and
					writer from Indianapolis, Indiana. It is intended to be a
					repository of content that is available but asocial in the
					sense that it is insulated from modern social networks.
				</p>
				<p>
					Here, in addition to project links and photos, you may find
					essays on topics in culture, politics, and technology, as
					well as travel writing from around Indiana and the
